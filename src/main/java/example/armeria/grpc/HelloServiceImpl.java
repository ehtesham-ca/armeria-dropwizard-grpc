...
public class HelloServiceImpl extends HelloServiceImplBase {
    ...
    public void hello(HelloRequest request, StreamObserver<HelloReply> responseObserver) {
        responseObserver.onNext(buildReply(toMessageWithCountry(request.getName(), request.getCountry())));
    ...
    static String toMessageWithCountry(String name, String country) {
